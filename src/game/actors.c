...
static const WorldActorDefinition g_town_actors[] = {
    {
        ...
        'M', "MAYOR", INTERACTION_DIALOGUE, 0, DIALOGUE_ID_MAYOR_GREETING, BATTLE_NONE, 0, 0, 0, 0, 0
    },
    {
        0, ENTITY_ID_GUARD, 10, 8, DIRECTION_DOWN,
        ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'G', "GUARD", INTERACTION_DIALOGUE, 0, DIALOGUE_ID_GUARD_GREETING, BATTLE_NONE, 0, 0, 0, 0, 0
    },
    {
        0, ENTITY_ID_SHOPKEEPER, 9, 3, DIRECTION_DOWN,
        ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'S', "SHOPKEEPER", INTERACTION_SHOP, 1, DIALOGUE_ID_NONE, BATTLE_NONE, 0, 0, 0, 0, 0
    },
     ...
     * becomes reachable only after the amulet is returned. */
    {
        ...
        ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'M', "MERCHANT", INTERACTION_SHOP, 2, DIALOGUE_ID_NONE, BATTLE_NONE, 0, 0, 0, 0, 0
    }
};
...
static const WorldActorDefinition g_field_actors[] = {
    {
        ...
        'E', "SLIME", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_SLIME, 5, 5, 5, 0, 0
    }
};
...
static const WorldActorDefinition g_forest_actors[] = {
    {
        ...
        ACTOR_FLAG_HOSTILE | ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'E', "SLIME", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_SLIME, 6, 6, 5, 0, 0
    },
    {
        3, ENTITY_ID_BAT, 7, 4, DIRECTION_DOWN,
        ACTOR_FLAG_HOSTILE | ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'V', "BAT", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_BAT, 4, 4, 8, 0, 0
    },
     ...
     * on first interact; afterwards the fallback dialogue plays. */
    {
        ...
        ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        '?', "AMULET", INTERACTION_DIALOGUE, 0, DIALOGUE_ID_AMULET_NOTHING, BATTLE_NONE, 0, 0, 0, 0, 0
    }
};
...
static const WorldActorDefinition g_mountain_pass_actors[] = {
    {
        ...
        ACTOR_FLAG_HOSTILE | ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'E', "SLIME", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_SLIME, 8, 8, 5, 0, 0
    }
};
...
static const WorldActorDefinition g_castle_actors[] = {
     ...
     * quest is COMPLETE (the sword is in the inventory). */
    {
        ...
        ACTOR_FLAG_HOSTILE | ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'L', "LORD OF SLIMES", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_NONE, 25, 25, 50,
