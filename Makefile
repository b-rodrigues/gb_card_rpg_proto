...
$(TARGET): $(OBJS) | $(BUILD_DIR)
	$(CC) -no-crt -Wm-yc -Wl-yt1 -Wl-yo4 -o $@ $(GBDKDIR)lib/gb/crt0.o $(OBJS) $(GBDKDIR)lib/gb/gb.lib $(GBDKDIR)lib/sm83/sm83.lib

$(TARGET_DEBUG): $(OBJS_DEBUG) | $(BUILD_DIR)
	$(CC) -no-crt -Wm-yc -Wl-yt1 -Wl-yo4 -Wl-m -Wl-j -Wl-y -o $@ $(GBDKDIR)lib/gb/crt0.o $(OBJS_DEBUG) $(GBDKDIR)lib/gb/gb.lib $(GBDKDIR)lib/sm83/sm83.lib
